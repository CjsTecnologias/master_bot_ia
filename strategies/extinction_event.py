...
class ExtinctionEvent(qx.BaseBot):
    def __init__(self):
        # Define o percentual do capital a ser usado em cada negociação
        self.trade_amount_percentage = 0.10  # 10%
    ...
    def get_trade_amount(self, currency_balance):
        """
        Calcula a quantidade de 'currency' a ser usada na próxima compra.
        Sobrescreve o método padrão da BaseBot para implementar o controle de risco.
        """
        # Retorna 10% do saldo atual em 'currency'
        return currency_balance * self.trade_amount_percentage
...
def main():
    ...
    data = qx.Data(
        exchange="binance",  # Options: "binance", "kucoin", "kraken", etc.
        asset=asset,
        currency=currency,
        begin="2025-01-01", # Ano-Mês-Dia (2025-01-01)
        end="2025-09-20",   # Ano-Mês-Dia (2025-09-01)
    )

    bot = ExtinctionEvent()
    # Usa o dispatcher com menu completo de opções
